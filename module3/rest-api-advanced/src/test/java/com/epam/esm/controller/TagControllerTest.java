...
class TagControllerTest {
    ...
    void should_ReturnJsonWithTagsAndLinks_When_GetTags() throws Exception {
        ...
        when(tagService.find(anyString(), anyString(), anyString(), anyInt(), anyInt()))
                .thenReturn(PagedModel.of(List.of(tagDto1, tagDto2),
        ...
        mvc.perform(MockMvcRequestBuilders.get("/tags")
                ...
                .andExpect(jsonPath("$._links.self.href")
                        .value("http://localhost/tags?search=&sortField=id&sortDirection=asc&offset=0&size=20"))
